...
class HEATargetFunction:
    ...
    def __init__(self):
        ...
        #self.reg_model = joblib.load("HEA.joblib")
        self.reg_model = joblib.load("gbr.pkl")
    ...
    def __call__(self, **kwargs):
        ...
        element = np.array(element) + 1e-8  # Add a small value to avoid zero
...
if __name__ == "__main__":
    ...
    parser.add_argument('--upsi_main', type=float, default=1)
    ...
    pd.concat(logs, axis=0).to_csv('hibo%d.csv'%(args.seed), index=False)