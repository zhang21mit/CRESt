...
3. Automated SEM control and image analysis could be located in crest.
4. Database control leveraging the SQL database could be located in db_control.
...
For controlling the hardware, the users need to have these hardware in the lab or install virtual machines to run the codes. 
